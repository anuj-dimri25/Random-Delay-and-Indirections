   ...
   //}
    ...
    //else if((simTime()- wsm->getCreationTime() > 100)|| mobility->getSpeed()<3)
              //{
                  //delete(wsm->dup());
              //}
    else if ((simTime()- wsm->getCreationTime() > 15) && (cc==6))
    {
       EV<<"uploaded to server at time "<<simTime()<<" message  name is "<<wsm->getFullPath()<<" ";


       std::ofstream myfile10;
              myfile10.open("Exampleall_23feb2_014.txt",std::ios_base::app);
              myfile10<<"all uplood "<<wsm->getFullPath()<<" "<<simTime()<<" "<<cc<<" "<<wsm->getCreationTime()<<" orig lon lat "<<wsm->getWsmData()<<"\n";
              myfile10.close();
       ...
       myfile0.open("Example0_23feb_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[0].veinsmobility")
                 ...
                 EV<<"uploaded by 00-id";
                    ...
                    myfile00.open("Example00_23feb_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[1].veinsmobility")
           ...
           EV<<"uploaded by 1-id";
              ...
              myfile1.open("Example1_23feb_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[2].veinsmobility")
           ...
           EV<<"uploaded by 2-id";
              ...
              myfile2.open("Example2_23feb_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[5].veinsmobility")
           ...
           EV<<"uploaded by 5-id";
              ...
              myfile5.open("Example5_23feb_014.txt",std::ios_base::app);
