   ...
   //}
    ...
    //else if((simTime()- wsm->getCreationTime() > 100)|| mobility->getSpeed()<3)
              //{
                  //delete(wsm->dup());
              //}
    else if ((simTime()- wsm->getCreationTime() > 14) && ((cc==6) || (cc==7)))
    {
       ...
       myfile0.open("Example0.txt",std::ios_base::app);
       myfile0<<"0-id "<<wsm->getFullPath()<<" "<<simTime()<<"\n";
       myfile0.close();
       }
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[1].veinsmobility")
              {
           EV<<"uploaded by 1-id";
                  EV<<"1-id "<<wsm->getFullPath()<<" "<<simTime()<<"\n";
              std::ofstream myfile1;
              myfile1.open("Example1.txt",std::ios_base::app);
              myfile1<<"1-id "<<wsm->getFullPath()<<" "<<simTime()<<"\n";
              myfile1.close();
              }
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[2].veinsmobility")
           ...
           EV<<"uploaded by 2-id";
              ...
              myfile2<<"2-id "<<wsm->getFullPath()<<" "<<simTime()<<"\n";
              myfile2.close();
              }
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[5].veinsmobility")
              {
           EV<<"uploaded by 5-id";
                  EV<<"5-id "<<wsm->getFullPath()<<" "<<simTime()<<"\n";
              std::ofstream myfile5;
              myfile5.open("Example5.txt",std::ios_base::app);
              myfile5<<"5-id "<<wsm->getFullPath()<<" "<<simTime()<<"\n";
              myfile5.close();
              }
     }
...
EV<<"time difference "<<simTime()-previous_msg_generated;
    if ( c<1000 && (simTime()-previous_msg_generated>3))
    //if (c<10000)
    ...
    sendDelayedDown(wsm,intuniform(5,10));
    //sendDown(wsm);
