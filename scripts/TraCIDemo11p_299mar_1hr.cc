...
void TraCIDemo11p::onWSM(WaveShortMessage* wsm) {
   ...
   //}
    ...
    static simtime_t uploaded[1000000]={};
    static int index=0;
    int i=0;
    int flag=0;
    for(i=0;i<1000000;i++)
    ...
    else if ((simTime()- wsm->getCreationTime() > 15) && (cc==6))
    {
       ...
       std::ofstream myfile10;
              myfile10.open("Exampleall_29mar_014.txt",std::ios_base::app);
       ...
       myfile0.open("Example0_29mar_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[0].veinsmobility")
                 ...
                 EV<<"uploaded by 00-id";
                    ...
                    myfile00.open("Example00_29mar_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[1].veinsmobility")
           ...
           EV<<"uploaded by 1-id";
              ...
              myfile1.open("Example1_29mar_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[2].veinsmobility")
           ...
           EV<<"uploaded by 2-id";
              ...
              myfile2.open("Example2_29mar_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[5].veinsmobility")
           ...
           EV<<"uploaded by 5-id";
              ...
              myfile5.open("Example5_29mar_014.txt",std::ios_base::app);
