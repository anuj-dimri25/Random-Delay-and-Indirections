   ...
   //}
    ...
    //else if((simTime()- wsm->getCreationTime() > 100)|| mobility->getSpeed()<3)
              //{
                  //delete(wsm->dup());
              //}
    else if ((simTime()- wsm->getCreationTime() > 15) && (simTime()-prev_upload_time[x] >15) && ((cc==7)||(cc==4)||(cc==6)||(cc==5)||(cc==9)||(cc==8)||(cc==10)))
    {
      ...
      EV<<"prev upload "<<prev_upload_time[x]<<" "<<x;
       ...
       std::ofstream myfile10;
              myfile10.open("Exampleall_29mar_100test_up.txt",std::ios_base::app);
       ...
       myfile0.open("Example0_29mar_100test_up.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[0].veinsmobility")
                 ...
                 EV<<"uploaded by 00-id";
                    ...
                    myfile00.open("Example00_29mar_100test_up.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[1].veinsmobility")
           ...
           EV<<"uploaded by 1-id";
              ...
              myfile1.open("Example1_29mar_100test_up.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[2].veinsmobility")
           ...
           EV<<"uploaded by 2-id";
              ...
              myfile2.open("Example2_29mar_100test_up.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[5].veinsmobility")
           ...
           EV<<"uploaded by 5-id";
              ...
              myfile5.open("Example5_29mar_100test_up.txt",std::ios_base::app);
