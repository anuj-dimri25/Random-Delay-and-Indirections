   ...
   //}
    ...
    //else if((simTime()- wsm->getCreationTime() > 100)|| mobility->getSpeed()<3)
              //{
                  //delete(wsm->dup());
              //}
    else if ((simTime()- wsm->getCreationTime() > 30) && ((cc==6) || (cc==7)))
    {
       ...
       myfile0.open("Example0_23jan_2.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[0].veinsmobility")
                 ...
                 EV<<"uploaded by 00-id";
                    ...
                    myfile00.open("Example00_23jan_2.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[1].veinsmobility")
           ...
           EV<<"uploaded by 1-id";
              ...
              myfile1.open("Example1_23jan_2.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[2].veinsmobility")
           ...
           EV<<"uploaded by 2-id";
              ...
              myfile2.open("Example2_23jan_2.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[5].veinsmobility")
           ...
           EV<<"uploaded by 5-id";
              ...
              myfile5.open("Example5_23jan_2.txt",std::ios_base::app);
