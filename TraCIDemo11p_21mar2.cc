   ...
   //}
    ...
    else if ((simTime()- wsm->getCreationTime() > 15) && (cc==6))
    {
       ...
       std::ofstream myfile10;
              myfile10.open("Exampleall_21mar2_014.txt",std::ios_base::app);
       ...
       myfile0.open("Example0_21mar2_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[0].veinsmobility")
                 ...
                 EV<<"uploaded by 00-id";
                    ...
                    myfile00.open("Example00_21mar2_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[1].veinsmobility")
           ...
           EV<<"uploaded by 1-id";
              ...
              myfile1.open("Example1_21mar2_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[2].veinsmobility")
           ...
           EV<<"uploaded by 2-id";
              ...
              myfile2.open("Example2_21mar2_014.txt",std::ios_base::app);
       ...
       if (mobility->getFullPath()=="RSUExampleScenario.node[5].veinsmobility")
           ...
           EV<<"uploaded by 5-id";
              ...
              myfile5.open("Example5_21mar2_014.txt",std::ios_base::app);
